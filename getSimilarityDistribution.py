...
plt.plot(jx, js, '#4876ff', label='Our Framework', linewidth=2.5)
...
plt.plot(px, ps, '#4876ff', label='Our Framework', linewidth=2)
plt.xlabel(u'Pearson Coeffecient', fontsize=14)
plt.ylabel(u'PDF', fontsize=14)
plt.legend(loc='upper right', fontsize=20);
...
plt.plot(jx, js, '#4876ff', label='Our Framework', linewidth=2)
plt.xlabel(u'Jaccard Index', fontsize=14)
plt.ylabel(u'PDF', fontsize=14)
plt.legend(loc='upper right', fontsize=20);
