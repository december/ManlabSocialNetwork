...
plt.plot(ss, sn, '#4876ff', label='Our method', linewidth=2.5)
plt.plot(ss1, sn1, '#8c8c8c', linestyle='--', label='BP', linewidth=2.5)
plt.plot(ss2, sn2, '#ffa500', label='EP', linewidth=2.5)
plt.plot(ss3, sn3, '#458b00', linestyle='--', label='Base', linewidth=2.5)
